    ...
    static class MimeItemExtensions
    {
        ...
        public static void Source(this Windows.ApplicationModel.DataTransfer.DataPackage dataPackage, IMimeItemCollection mimeItemCollection)
        {
            ...
            if (mimeItemCollection.Description != null)
                properties.Description = mimeItemCollection.Description ?? P42.Utils.Uno.AppInfo.Name;
            properties.ApplicationName = P42.Utils.Uno.AppInfo.Name;

            properties.Title = mimeItemCollection.Description ?? "Share " + P42.Utils.Uno.AppInfo.Name + " data ...";
