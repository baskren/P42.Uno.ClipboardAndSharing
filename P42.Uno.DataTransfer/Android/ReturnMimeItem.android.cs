...
namespace P42.Uno.DataTransfer.Droid
{
    ...
    class AndroidUriMimeItem : IMimeItem
    {
            ...
            get
            {
                if (_cursor == null)
                {
                    try
                    {
                        ...
                        {
                        */
                        var loader = new AndroidX.Loader.Content.CursorLoader(Android.App.Application.Context, _uri, null, null, null, null);   
                        _cursor = (ICursor)loader.LoadInBackground();
                        //}
                    }
                    catch (Exception e)
        ...
        {
            _uri = uri;
            MimeType = Android.App.Application.Context.ContentResolver.GetType(uri);
        }
