...
namespace P42.Uno.DataTransfer
{
    ...
    public class MimeItemCollection : BaseMimeItemCollection
    {
        ...
        public new string Description { get; set; } = P42.Utils.Uno.AppInfo.Name + " Clipboard";
        ...
        #region Constructor
        /// <summary>
        /// Initializes a new instance of the <see cref="T:P42.Uno.DataTransfer.MimeItemCollection"/> class.
        /// </summary>
